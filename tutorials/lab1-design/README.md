...
Добавим странице цвет, нажимаем на фрейм, в правой панели находим вкладку **Заполнить** - она отвечает за заливку, нажимаем на квадратик. Ползунок позволяет выбрать цвет. Можно также выбрать цветовую модель и ввести код цвета.
...
Выбираем вертикально расположение, интервал между элементами 10px, внутренний отступ (padding) 8px. Добавляем заливку белым цветом. Скругление углов 12px. Проверяем, что изменение размера по ветикали/горизонтали - Hug.
